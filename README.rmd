...
## <a name="2"></a>
## Error tables
This function supports multiple subsets. In the first example we use the function to report error by source. Next we will compute errors by source and country.
```{r, warning = FALSE}
